...
export const STYLE_SAMPLES: Record<CategoryId, Sample> = {
  personal_messages: {
    formal: "Hey, are we still on for coffee tomorrow? I think 10 a.m. works unless you need to change it.",
    casual: "hey are we still on for coffee tmrw? 10 works unless u need to change it",
    excited: "hey!! are we still on for coffee tomorrow?? 10 works unless you need to change it!!",
  },
  work_messages: {
    formal: "Hi team — quick update: the API rollout is on track for Friday. Let me know if anything is blocking.",
    casual: "quick update — API rollout is on track for Friday. let me know if anything's blocking",
    excited: "quick update! API rollout is on track for Friday 🎉 lmk if anything's blocking!",
  },
  email: {
    formal:
  ...
  other: {
    formal: "Reviewed the Q3 numbers. Revenue is up 12 percent quarter over quarter with stronger enterprise retention.",
    casual: "looked at Q3 numbers — revenue's up 12% QoQ with better enterprise retention",
    excited: "Q3 numbers are in — revenue up 12% QoQ and enterprise retention is way stronger!",
  },
};
