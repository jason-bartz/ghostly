...
export const MaxUpgradePage: React.FC<MaxUpgradePageProps> = ({
  ...
  return (
    <div
      className="app-canvas modal-scrim fixed inset-0 z-50 flex justify-center overflow-y-auto p-6"
      onClick={onClose}
    >
      <div
        ref={dialogRef}
        ...
        className="glass-raised animate-rise my-auto w-full max-w-3xl overflow-hidden rounded-2xl"
      >
