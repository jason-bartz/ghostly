...
const settingUpdaters: {
  ...
  staged_overlay_position: (value) =>
    commands.changeStagedOverlayPositionSetting(value as string),
  debug_mode: (value) => commands.changeDebugModeSetting(value as boolean),
  custom_words: (value) => commands.updateCustomWords(value as string[]),
  custom_word_phonetics: (value) =>
    commands.updateCustomWordPhonetics(value as Record<string, string>),
  ...
  profiles_enabled: (value) => commands.setProfilesEnabled(value as boolean),
  voice_editing_enabled: (value) =>
    commands.setVoiceEditingEnabled(value as boolean),
  voice_edit_prefix_detection: (value) =>
    commands.setVoiceEditPrefixDetection(value as boolean),
  voice_edit_replace_strategy: (value) =>
    commands.setVoiceEditReplaceStrategy(value as any),
  session_buffer_size: (value) =>
    commands.setSessionBufferSize(value as number),
  session_idle_timeout_secs: (value) =>
    commands.setSessionIdleTimeoutSecs(value as number),
};
