; Custom NSIS template for Ghostly with portable mode support.
...
Function PageLeaveInstallType
  ...
  ${If} $0 = ${BST_CHECKED}
    ...
    ; --- PORTABLE MODE --- Switch default directory to Desktop\Ghostly for portable
...
Function .onInit
  ...
  ; or the legacy empty marker created by older Ghostly releases. Require Data/
...
Section Install
  ...
  ${If} $PortableMode = 1
    ...
    FileWrite $0 "Ghostly Portable Mode"
    FileClose $0
